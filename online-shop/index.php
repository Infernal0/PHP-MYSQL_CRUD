...
<div class="products">
   ...
   <h1 class="heading">recent products</h1>
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('remove object from cart ?');">Delete</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="index.php?delete_all" onclick="return confirm('remove all products from cart');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Delete All</a></td>
      </tr>
   </tbody>
   </table>
